defmodule HyperlogWeb.TutorialControllerTest do
  use HyperlogWeb.ConnCase

  alias Hyperlog.Resources

  @create_attrs %{description: "some description", difficulty: 42, link: "some link", title: "some title"}
  ...
  def fixture(:tutorial) do
    {:ok, tutorial} = Resources.create_tutorial(@create_attrs)
    tutorial
  end
